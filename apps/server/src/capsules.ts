...
const CapsuleSchema = z.object({
    encryptedPayload: z.string().default(''),
...
router.put('/:id', async (req: AuthRequest, res: Response) => {
    ...
    try {
        ...
        const updated: Capsule = {
            ...
            encryptedTitle: data.encryptedTitle ?? existing.encryptedTitle,
            encryptedContent: data.encryptedContent ?? existing.encryptedContent,
            iv: data.iv || existing.iv,
            salt: data.salt || existing.salt,
            hmac: data.hmac ?? existing.hmac,
            ...
            unlockAt: data.unlockAt ?? existing.unlockAt,
            aura: data.aura ?? existing.aura,
        };
