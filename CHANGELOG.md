...
### ✨ Added
- **Aura Customization**: Personalize your memories with neon color themes.
  - Choose from 5 auras: Purple, Cyan, Gold, Red, and Green.
  - Capsule cards glow with the selected aura color.
  - Unlock screens adapt to match the capsule's theme.
  - Aura metadata is preserved during Backup/Restore.

## [1.1.0] - 2025-11-25

### ✨ Added
- **Time-Locked Capsules**: You can now seal capsules until a specific future date.
  - Added "Time Lock" option in Create Capsule modal.
  - Locked capsules show a countdown/lock icon on the dashboard.
  - Security enforcement prevents opening locked capsules before the due date.
  - Time-lock metadata is preserved during Backup/Restore.

## [1.0.2] - 2025-11-24

### ✨ Improved
- **Capsule Cards**: Added visible Capsule ID to each card to facilitate searching
- **Password Visibility**: Added "Eye" icon toggle to show/hide passwords
  - Available in **Unlock Modal** when accessing capsules
  - Available in **Create Capsule Modal** when setting new passwords
